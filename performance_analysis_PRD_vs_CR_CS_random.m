...
% adopting the CS with a sensing matrix, Bernoulli or Gaussian distributed,
% and a Dictionary, Mexican Hat or Symlet 4 or others.
...
% CS processing of the ECG signal
    [xest,xcut,alpha,y,Phi,Psi] = CS_random(x,N,M(ii),'Bernoulli','sym4',0.2,'cvx'); % compression and reconstruction of the entire ECG signal
...
save('./Results/PRD_vs_CR_CS_random.mat')
